...
function BudgetItem({ budget }) {
  ...
  return (
    ...
    hover:shadow-xl hover:shadow-neutral-400 hover:bg-blue-50 cursor-pointer h-[170px]"
      >
        <div className="flex gap-2 items-center justify-between">
          <div className="flex gap-2 items-center p-1 lg:p-3 ">
            {/* <h2
        ...
        <div className="mt-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <h2 className="text-xs text-slate-700">
